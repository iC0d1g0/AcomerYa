...
class Aperitivos_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var imagen04: ImageView = findViewById(R.id.aperitivos_tortilla_huevo)
        ...
        val imagen13: ImageView = findViewById(R.id.aperitivos_batidos)
        val texto13="Las batidas de siempre"
        clickeame(imagen13, resource13, texto13)


        val imagen14: ImageView = findViewById(R.id.aperitivos_tarta)
